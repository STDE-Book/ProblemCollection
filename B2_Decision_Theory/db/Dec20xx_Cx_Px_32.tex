...
%\part Design the ML classifier for such situation, and calculate $P_\text{FA}$, $P_\text{M}$, and the mean cost incurred by such classifier.
...
\part Provide, as a function of $\eta'$, an expression for the mean cost of the threshold classifier considered in the previous subsection. Find the value of $\eta'$ that minimizes such mean cost.
