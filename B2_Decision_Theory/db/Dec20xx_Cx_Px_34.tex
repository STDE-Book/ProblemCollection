...
\begin{parts}
  \part Calculate the probability of error of the MAP decider.
  \part Design the Neyman-Pearson decider satisfying $P_\text{FA} \le 1/4$.
...
the mean cost of each possible decision as a function of $X$, i.e., calculate
\[
\mathbb E\{c_{0,H}|x\}, \; \mathbb E\{c_{1,H}|x\}  \mbox{ and } \mathbb E\{c_{2,H}|x\} 
\]

\part Plot the mean costs calculated in the previous section as a function of the observation $x$, and
determine the decision regions of the minimum mean cost classifier.
\end{parts}
