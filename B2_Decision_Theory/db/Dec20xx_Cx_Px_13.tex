...
\part Plot the ROC curves (i.e., the curves that represent $P_{\rm D}$ as a function of $P_{\rm FA}$), corresponding to decision makers DEC1 and DEC2.  Discuss how the operation points of both classifiers change when modifying the corresponding threholds.
...
We decide the only plausible hypothesis where $ p_{X_1,X_2|H}(x_1,x_2 | 0) $ or $ p_{X_1,X_2|H}(x_1,x_2 | 1) $ are zero. In the region where both likelihoods overlap, considering the LRT given by $\displaystyle \frac{ p_{X_1,X_2|H}(x_1,x_2 | 0) }{ p_{X_1,X_2|H}(x_1,x_2 | 1) } \dceroduno \eta$, the decision maker is:
 $$ 2x_2 - \eta x_1 \dceroduno 0$$
