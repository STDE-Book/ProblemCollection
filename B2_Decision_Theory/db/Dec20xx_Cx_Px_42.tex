...
\begin{parts}
\part Find the decision regions of an LRT decider with parameter $\eta$:
$$\frac{p_{X|H}(x|1)}{p_{X|H}(x|0)}\dunodcero \eta.$$
\part Provide an approximate plot of the ROC of the LRT classifier.
\part Indicate which point of the ROC corresponds to the operating point of the ML decider.
\part Indicate which point of the ROC corresponds to the operating point of the minimax decider.
\part Indicate which point of the ROC corresponds to the operating point of Neyman Pearson classifier with $\pfa \le 0.4$.
\end{parts}
