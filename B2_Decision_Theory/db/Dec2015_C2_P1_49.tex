...
\end{align}
\begin{parts}
\part Compute the decision regions of the ML decision maker based on $x$.
\part Compute the missing probability of the ML decision maker.
\part Compute the false alarm probability of the ML decision maker.
\end{parts}
