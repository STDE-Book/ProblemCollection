...
\setcounter{partno}{1}
\part Obtain  $x_u^*$.
\part  Find the increment of the mean cost that would be produced when applying the minimax strategy over the cost that would be obtained if the value of $a$ were known.
\end{parts}
