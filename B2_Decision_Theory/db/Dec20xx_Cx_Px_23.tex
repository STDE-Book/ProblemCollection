...
\part Calculate the probability of error of this decider.
\part Design the Neyman-Pearson decider that guarantees a $P_{\rm FA}$ not larger than a pre-established value $\alpha$.
\end{parts}
