...
\begin{parts}
\part Find the MAP decider.
\part Obtain the probability of missing of the MAP decider.
\part Assume now that the same decider that was designed in subsection (a) is applied to a scenario in which the likelihood of $H=1$ is
\[
p'_{X|H}(x|1) = \frac{7}{8} p_{X|H}(x|1)
              + \frac{1}{16},
\]
