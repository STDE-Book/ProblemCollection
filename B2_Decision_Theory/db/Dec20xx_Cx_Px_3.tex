...
Consider a generic LRT decider with threshold $\eta$,
\begin{parts}
\part Calculate $P_{\rm FA}$ as a function of $\eta$.
\part The following plot represents the ROC curve of the LRT. Justifying your answer:
\begin{itemize}
...
\item Place on the ROC the operation points corresponding to the ML decider, to the decider with minimum probability of error, and to the Neyman-Pearson classifier with $P_{\rm FA} = 0.3$.
\end{itemize}
...
\item
ML decider: $\eta=1$, $\eta'=\displaystyle  \frac{2}{3}$, $P_{\rm FA}=\displaystyle  \frac{5}{9}$.\\
MAP decider: $\eta=\displaystyle  \frac{3}{2}$,	$\eta'=1$,	$P_{\rm FA}=0$.\\
N-P decider:	$P_{\rm FA}=0.3$.
	\end{itemize}
\end{parts}
