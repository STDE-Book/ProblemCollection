...
\part Knowing that $c_{00} = c_{11} = 0$, $c_{01}=1$ y $c_{10}=3$, express the mean cost of the classifier as a function of $\eta$ and find the optimum threshold minimizing such mean cost.
\end{parts}
