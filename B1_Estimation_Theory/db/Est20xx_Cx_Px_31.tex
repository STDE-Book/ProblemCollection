...
\begin{solution}
 ...
 \part $\displaystyle p_{X,S}(x,s) = s \exp (-x) \quad x>s, \; s>0$\\
 $\displaystyle p_{S|X}(s|x)= \frac{2s}{x^2} \quad 0<s<x,\; x>0$
...
\begin{solution}
 ...
 $\displaystyle p_{S|X}(s|x)= \frac{2s}{x^2} \quad 0<s<x,\; x>0$
 \part  $\widehat{S}_\text{MAP}=X$
 \part  $\displaystyle \widehat{S}_\text{MMSE}=\frac{2}{3}X$
 \part $\mathbb E \left\lbrace S- \widehat S_{\text{ML}}  \right\rbrace= \mathbb E \left\lbrace S- \widehat S_{\text{MAP}} \right\rbrace = -1$ \\
 $\mathbb E \left\lbrace S- \widehat S_{\text{MMSE}}  \right\rbrace= 0 $\\
  $ \displaystyle {\rm Var} \left\lbrace \widehat S_{\text{MMSE}}  \right\rbrace < {\rm Var} \left\lbrace  \widehat S_{\text{MAP}}  \right\rbrace= {\rm Var} \left\lbrace  \widehat S_{\text{ML}}  \right\rbrace$
