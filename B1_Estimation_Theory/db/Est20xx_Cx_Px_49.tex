...
\part Calcule $\mathbb E[U]$, $\mathbb E[U^2]$ y $\mathbb E[V]$.
\part Obtenga el estimador LMMSE de $V$ dado $U$, $\hat{v}_\text{LMMSE}(u)$.
\end{parts}
...
\part $\mathbb E[U] = 2/3$, $\mathbb E[U^2]=1/2$ and $\mathbb E[V]=1/3$
\part $\hat{v}_\text{LMMSE}(u)=u/2$.\end{parts}
\end{solution}
...
\part Compute $\mathbb E[U]$, $\mathbb E[U^2]$ and $\mathbb E[V]$.
\part Compute the LMMSE estimator of $V$ given $U$, $\hat{v}_\text{LMMSE}(u)$.
\end{parts}
