...
%% 46 %%%%%%%%%%% Enero 2014 Q2: Estimación lineal MSE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\qformat{\textbf{\ej \thequestion ~~ (LMSE)} ~~ \linefill}
\input{db/Est20xx_Cx_Px_46.tex}

%% 47 %%%%%%%%%%% Enero 2014 P1: Estimación lineal MSE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\qformat{\textbf{\ej \thequestion ~~ (ML)} ~~ \linefill}
\input{db/Est20xx_Cx_Px_47.tex}

%% 48 %%%%%%%%%%% Junio 2014 Q2: Estimación lineal MSE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
