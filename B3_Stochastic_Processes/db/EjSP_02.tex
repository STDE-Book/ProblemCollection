...
\begin{align*}
S_X(w) &= 5 + 2\pi \delta(\omega),   \qquad\qquad  -\pi \le \omega \le \pi 
\end{align*}
\part 
\begin{align*}
r_Y[n] &= r_Y[n] \ast h[n] \ast h[-n]    \\
       &= \frac{4}{3} \left(\frac{1}{2}\right)^{-|n|} \ast (2 + 5 \delta[n]) 
        = 8 + \frac{25}{4} \left(\frac{1}{2}\right)^{-|n|} \\
%\end{align*}
%\begin{align*}
S_Y(w) &= S_X(w) |H(\omega)|^2   \\
        &= \frac{5 + 2\pi \delta(\omega)}{\left|1 - \frac12 e^{-j\omega} \right|^2 }  
\end{align*}
(This expression can be further simplified to
\begin{align*}
S_Y(w) &= \frac{5 + 2\pi \delta(\omega)}{\frac54 - \cos(\omega)}
        = \frac{5}{\frac54 - \cos(\omega)} + 8\pi \delta(\omega)
\end{align*}
). 
