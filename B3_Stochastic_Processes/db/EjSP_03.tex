...
r_Y[n] 
	...
	&= (2 \delta[n] + 4) \ast (1.5 \delta[n] + 0.5\delta[n-1] + 0.5\delta[n+1]) \\
	&= 3 \delta[n] + \delta[n-1] + \delta[n+1] + 10
\end{align*}

\part Since $Y_n$ and $E_n$ are independent and $E_n$ is zero-mean
\begin{align*}
r_Z[n] = r_Y[n] + r_E[n] = 4 \delta[n] + \delta[n-1] + \delta[n+1] + 10
\end{align*}

\part Computing the Fourier transform of the autocorrelation function, we get
\begin{align*}
S_Z(\omega) = 4 + 2 \cos(\omega) + 20 \pi \delta(\omega),    \qquad \omega \in [-\pi, \pi]
\end{align*}
