...
\question
\input{db/EjSP_01.tex}

%%%%%%%%
\qformat{\textbf{\ej MP\thequestion ~~ (Markov Process)} ~~ \linefill}
\question
\input{db/SP2021_C2_P1.tex}

%%%%%%%%
\qformat{\textbf{\ej MP\thequestion ~~ (Markov Processes)} ~~ \linefill}
\question
\input{db/SP202205_C1_P1.tex}
...
\question
\input{db/EjSP_03.tex}

%%%%%%%%
\qformat{\textbf{\ej SP\thequestion ~~ (Autocorrelation, Power Spectrum)} ~~ \linefill}
\question
\input{db/SP2022_SP_partial.tex}


%%%%%%%%
\qformat{\textbf{\ej SP\thequestion ~~ (Autocorrelation, Power Spectrum)} ~~ \linefill}
\question
\input{db/SP2021_C1_P1.tex}

%%%%%%%%
\qformat{\textbf{\ej SP\thequestion ~~ (Autocorrelation, Power Spectrum)} ~~ \linefill}
\question
\input{db/EjSP_02.tex}

%%%%%%%%
\qformat{\textbf{\ej SP\thequestion ~~ (Autocorrelation, Power Spectrum)} ~~ \linefill}
\question
\input{db/SP202206_C2_P1.tex}

%%%%%%%%
\qformat{\textbf{\ej SP\thequestion ~~ (Autocorrelation, Power Spectrum)} ~~ \linefill}
\question
\input{db/SP202206_C2_P1b.tex}
